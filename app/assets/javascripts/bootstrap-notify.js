...
(function ($) {
  ...
  Notification.prototype.show = function () {
    if (this.options.fadeOut.enabled)
      this.$note.delay(this.options.fadeOut.delay || 4000).fadeOut('slow', $.proxy(Notification.onClose, this));
...
// This applies the notification to the div if present.
$(document).ready( function () {
	$('div.notifications').notify({    	
    	message: { text: $('div.notifications').data('notice-text') },
    	type: 'blackgloss'
    }).show();
});
